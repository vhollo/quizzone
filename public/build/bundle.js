...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "alt", "1");
    			add_location(img0, file, 81, 4, 2303);
    			attr_dev(figure0, "class", "svelte-5y4pgj");
    			add_location(figure0, file, 80, 3, 2269);
    			if (img1.src !== (img1_src_value = "/images/transport.jpeg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "2");
    			add_location(img1, file, 84, 4, 2391);
    			attr_dev(figure1, "class", "svelte-5y4pgj");
    			add_location(figure1, file, 83, 3, 2357);
    			if (img2.src !== (img2_src_value = "/images/animals.jpeg")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "3");
    			add_location(img2, file, 87, 4, 2484);
    			attr_dev(figure2, "class", "svelte-5y4pgj");
    			add_location(figure2, file, 86, 3, 2450);
    			if (img3.src !== (img3_src_value = "/images/nature.jpeg")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "4");
    			add_location(img3, file, 90, 4, 2575);
    			attr_dev(figure3, "class", "svelte-5y4pgj");
    			add_location(figure3, file, 89, 3, 2541);
    			if (img4.src !== (img4_src_value = "/images/people.jpeg")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "5");
    			add_location(img4, file, 93, 4, 2665);
    			attr_dev(figure4, "class", "svelte-5y4pgj");
    			add_location(figure4, file, 92, 3, 2631);
    			attr_dev(div0, "id", "qs");
    			attr_dev(div0, "class", "svelte-5y4pgj");
    			add_location(div0, file, 79, 2, 2227);
    			attr_dev(figcaption0, "draggable", "true");
    			attr_dev(figcaption0, "id", "txt-1");
    			attr_dev(figcaption0, "class", "svelte-5y4pgj");
    			add_location(figcaption0, file, 97, 3, 2757);
    			attr_dev(figcaption1, "draggable", "true");
    			attr_dev(figcaption1, "id", "txt-2");
    			attr_dev(figcaption1, "class", "svelte-5y4pgj");
    			add_location(figcaption1, file, 98, 3, 2843);
    			attr_dev(figcaption2, "draggable", "true");
    			attr_dev(figcaption2, "id", "txt-3");
    			attr_dev(figcaption2, "class", "svelte-5y4pgj");
    			add_location(figcaption2, file, 99, 3, 2929);
    			attr_dev(figcaption3, "draggable", "true");
    			attr_dev(figcaption3, "id", "txt-4");
    			attr_dev(figcaption3, "class", "svelte-5y4pgj");
    			add_location(figcaption3, file, 100, 3, 3016);
    			attr_dev(figcaption4, "draggable", "true");
    			attr_dev(figcaption4, "id", "txt-5");
    			attr_dev(figcaption4, "class", "svelte-5y4pgj");
    			add_location(figcaption4, file, 101, 3, 3105);
    			attr_dev(div1, "id", "as");
    			attr_dev(div1, "class", "as svelte-5y4pgj");
    			add_location(div1, file, 96, 2, 2729);
    			add_location(div2, file, 78, 1, 2153);
    			...
    			dispose = [
    				...
    				listen_dev(div2, "drop", /*_drop*/ ctx[4], false, false, false),
    ...
    function instance($$self) {
    	...
    	return [_focusFig, _blurFig, _moveTxt, _dragover, _drop];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 10, 1, 183);
    			add_location(p, file$1, 11, 1, 214);
    			add_location(header, file$1, 9, 0, 173);
    			attr_dev(main, "id", "questions");
    			add_location(main, file$1, 14, 0, 334);
    			add_location(h6, file$1, 19, 1, 393);
    			add_location(footer, file$1, 18, 0, 383);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
